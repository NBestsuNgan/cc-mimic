...
from src.prompts.system import get_compression_prompt
...
class ChatCompactor:
    ...
    def _format_history_for_compaction(self, messages: list[dict[str, Any]]) -> str:
        ...
        for msg in messages:
            ...
            if role == "tool":
                ...
                output.append("Assitant called tools:\n" + "\n".join(tool_details))             
            else: # user
    ...
    ) -> tuple[str | None, TokenUsage | None]: # tokenusage that have done for this compaction
