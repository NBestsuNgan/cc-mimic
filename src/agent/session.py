...
from src.tools.skills.skill_manager import SkillManager
...
class Session:
    def __init__(self, config: Config):
        ...
        self.tool_registry = create_default_registry(config=config) # register built-in tool and sub-agent and skills
    ...
    async def initialize(self) -> None:
        ...
        await self.skill_manager.initialize() # inital iterate and gather skills
        self.skill_manager.register_skills(self.tool_registry)
        ...
        skills = [
            ...
            for s in self.tool_registry.get_skills()
        ]
