...
from src.tools.base import Tool, ToolInvocation, ToolKind, ToolResult, FileDiff, ToolConfirmation
...
class WriteFileTool(Tool):
    ...
    async def get_confirmation(self, invocation: ToolInvocation) -> ToolConfirmation | None:
        ...
        return ToolConfirmation(
            ...
            diff=diff,
            affected_paths=[path],
            is_dangerous=not is_new_file, # overwrite count as dangerous because the user may lose the content
        )
