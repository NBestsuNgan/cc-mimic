...
from src.tools.base import FileDiff, Tool, ToolInvocation, ToolKind, ToolResult, ToolConfirmation
...
class EditTool(Tool):
    ...
    async def get_confirmation(self, invocation: ToolInvocation) -> ToolConfirmation | None:
        ...
        if params.replace_all:
            ...
            new_content = old_content.replace(params.old_string, params.new_string, 1) # want to replace once
